        ...
        <div className={`bg-white rounded-lg shadow-sm border border-gray-200 p-4 ${className}`}>
            <div className="flex items-center justify-between mb-4">
                ...
                <div className="flex items-center space-x-2">
                    <div className={`w-2 h-2 rounded-full ${monitoring.isActive ? 'bg-green-500 animate-pulse' : 'bg-gray-400'
                        }`} />
            ...
            <div className="mb-6">
                <div className="flex items-center justify-between mb-2">
                    ...
                    <span className={`text-sm font-medium px-2 py-1 rounded ${getConfidenceColor(currentConfidence.overall)
                        }`}>
                ...
                <div className="w-full bg-gray-200 rounded-full h-3 mb-2">
                    <div
                        className={`h-3 rounded-full transition-all duration-300 ${currentConfidence.overall >= 0.8
                            ? 'bg-green-500'
            ...
            <div className="grid grid-cols-3 gap-4 mb-4">
                <div className="text-center">
                    ...
                    <div className={`text-lg font-bold ${currentConfidence.gaze >= 0.7 ? 'text-green-600' :
                    ...
                    <div className="w-full bg-gray-200 rounded-full h-1 mt-1">
                        <div
                            className={`h-1 rounded-full ${currentConfidence.gaze >= 0.7 ? 'bg-green-500' :
                ...
                <div className="text-center">
                    ...
                    <div className={`text-lg font-bold ${currentConfidence.headPose >= 0.7 ? 'text-green-600' :
                    ...
                    <div className="w-full bg-gray-200 rounded-full h-1 mt-1">
                        <div
                            className={`h-1 rounded-full ${currentConfidence.headPose >= 0.7 ? 'bg-green-500' :
                ...
                <div className="text-center">
                    ...
                    <div className={`text-lg font-bold ${currentConfidence.environment >= 0.7 ? 'text-green-600' :
                    ...
                    <div className="w-full bg-gray-200 rounded-full h-1 mt-1">
                        <div
                            className={`h-1 rounded-full ${currentConfidence.environment >= 0.7 ? 'bg-green-500' :
